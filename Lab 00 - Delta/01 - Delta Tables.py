...
# MAGIC ###ALTER TABLE
# MAGIC
# MAGIC To modify the schema or properties of a table. Refer this [page](https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/sql-ref-syntax-ddl-alter-table) for additional details
...
# MAGIC %md
# MAGIC ###LAB Exercise : Add a constraint to the table for **id** to not be NULL. Refer this [page](https://learn.microsoft.com/en-us/azure/databricks/tables/constraints#not-null-constraint) for syntax help
...
# MAGIC
# MAGIC SELECT * FROM table_changes('stores', 10, 12) -- Note that we increment versions due to UPDATE statements above
...
# MAGIC %sql
# MAGIC delete from stores where store_id = 'SYD02'

# COMMAND ----------

# MAGIC %sql
# MAGIC select  * from stores where store_id = 'SYD02'
