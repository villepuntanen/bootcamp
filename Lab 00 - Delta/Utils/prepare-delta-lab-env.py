...
#datasets_location = f'../../DatasetsWork/'
...
import os
#/Workspace/Users/admin@mngenvmcap347012.onmicrosoft.com/apjbootcamp2023/Datasets/dimensions/orange_qualities.csv



working_dir = '/'.join(os.getcwd().split('/')[0:5])
#git_datasets_location = f'{working_dir}/Datasets/dimensions/'
#git_datasets_location = f'/dbfs/Volumes/
# git_datasets_location = f'../../Datasets/dimensions/'
git_datasets_location = f'/Workspace/Users/{current_user_id}/apjbootcamp2023/Datasets/dimensions/'
print (git_datasets_location)
