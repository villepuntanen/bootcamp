...
# MAGIC
# MAGIC ![ff](/Volumes/tbd_ville_test/default/randomfiles/DLT.png)
...
notebook_path = f"/Workspace/Users/{current_user_id}/apjbootcamp2023/Lab 01 - Data Engineering/01b - DLT/2 - Transform"

displayHTML("""<h2>Use these values to create your Delta Live Pipeline</h2>""")
displayHTML("""<b>Notebook path: </b>""")
...
# MAGIC %sql
# MAGIC SELECT * FROM event_log("72762c54-4462-40b6-aa42-22b13a9c66f8")
